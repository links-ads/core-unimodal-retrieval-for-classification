...
from ...utils import cos_sim, dot_score, l2
...
class DenseRetrievalExactSearch():
    def __init__(self, model, batch_size: int = 128, corpus_chunk_size: int = 50000, **kwargs):
        ...
        self.score_functions = {"cos_sim": cos_sim, "dot": dot_score, "l2": l2}
    ...
    def search(
        ...
        **kwargs,
        ...
        query_embeddings = self.model.encode_queries(queries, q_type=q_type)
        ...
        for batch_num, corpus_start_idx in enumerate(itr):
            ...
            sub_corpus_embeddings = self.model.encode_corpus(corpus[corpus_start_idx:corpus_end_idx], c_type=c_type)
